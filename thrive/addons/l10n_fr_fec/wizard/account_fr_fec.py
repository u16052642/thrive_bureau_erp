...
from thrive.exceptions import UserError, AccessDenied
from thrive.tools import float_is_zero, pycompat
...
class AccountFrFec(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # but Thrive has the label on the account.move.line, so that's a
        # problem !
