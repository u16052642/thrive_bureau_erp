...
from thrive.addons.l10n_ar.tests.common import TestAr
from thrive.addons.account_reports.tests.common import TestAccountReportsCommon
    ...
    def _create_test_vendor_bill_invoice_demo(self):
        ...
        vendor_bills = {
            "test_vendor_bill_1": {
                ...
                "ref": "demo_sup_invoice_6: Service Import to Thrive Bureau ERP, fiscal position changes tax not correspond",
