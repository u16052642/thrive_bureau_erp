...
class TestL10nClDte(TestL10nClEdiCommon):
    @patch('thrive.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_seed_ws')
    ...
    @patch('thrive.addons.l10n_cl_edi.models.l10n_cl_edi_util.Client')
    @patch('thrive.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_signed_token')
    @patch('thrive.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_seed_ws')
    ...
    @patch('thrive.addons.l10n_cl_edi.models.l10n_cl_edi_util.Client')
    @patch('thrive.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_signed_token')
    @patch('thrive.addons.l10n_cl_edi.models.l10n_cl_edi_util.L10nClEdiUtilMixin._get_seed')
