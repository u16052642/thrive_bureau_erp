...
from thrive.tools import float_compare
from thrive.tools.misc import formatLang
...
class FetchmailServer(models.Model):
    ...
    l10n_cl_last_uid = fields.Integer(
        ...
        help='This value is pointing to the number of the last message read by thrive '
            ...
            if float_compare(move.amount_total, xml_total_amount, precision_digits=move.currency_id.decimal_places) != 0:
                move.message_post(
                    body=_('<strong>Warning:</strong> The total amount of the DTE\'s XML is %s and the total amount '
                           'calculated by Thrive is %s. Typically this is caused by additional lines in the detail or '
