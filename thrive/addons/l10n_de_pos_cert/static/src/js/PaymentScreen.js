thrive.define('l10n_de_pos_cert.PaymentScreen', function(require) {
    "use strict";
                ...
                this._handlePushOrderError = async (error) => {
                    if (error.code === 'fiskaly') {
                        const message = {
                            ...
                            'unknown': this.env._t('An unknown error has occurred ! Please contact Thrive for more information.')
                        };
                ...
                if (this.currentOrder.isTransactionInactive()) {
                    try {
                        ...
                        if (error.status === 0) {
                            ...
                            const message = {'unknown': this.env._t('An unknown error has occurred ! Please, contact Thrive.')};
                            this.trigger('fiskaly-error', {error, message});
                        }
                    }
                }
