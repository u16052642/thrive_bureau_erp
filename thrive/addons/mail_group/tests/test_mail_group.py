...
from thrive.addons.mail_group.tests.common import TestMailListCommon
from thrive.exceptions import ValidationError, AccessError
from thrive.tests.common import users
from thrive.tools import mute_logger, append_content_to_html
...
class TestMailGroup(TestMailListCommon):
    ...
    @mute_logger('thrive.addons.base.models.ir_rule', 'thrive.addons.base.models.ir_model')
    @users('employee')
