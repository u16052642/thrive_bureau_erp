...
from thrive.http import root, Request, Response, SessionExpiredException
from thrive.modules.registry import Registry
from thrive.service import model as service_model
from thrive.service.server import CommonServer
from thrive.service.security import check_session
...
def acquire_cursor(db):
    ...
    for tryno in range(1, MAX_TRY_ON_POOL_ERROR + 1):
        with suppress(PoolError):
            return thrive.registry(db).cursor()
