...
from thrive.modules.module import get_manifest
...
class TestAssetsGenerateTimeCommon(thrive.tests.TransactionCase):
    ...
    def generate_bundles(self):
        ...
        for bundle in bundles:
            with mute_logger('thrive.addons.base.models.assetsbundle'):
...
@thrive.tests.tagged('post_install', '-at_install', 'assets_bundle')
...
@thrive.tests.tagged('post_install', '-at_install', '-standard', 'assets_bundle')
...
class TestLoad(HttpCase):
    def test_assets_already_exists(self):
        ...
        _save_attachment = thrive.addons.base.models.assetsbundle.AssetsBundle.save_attachment
        ...
        with patch('thrive.addons.base.models.assetsbundle.AssetsBundle.save_attachment', save_attachment):
