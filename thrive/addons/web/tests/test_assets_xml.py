...
import thrive
from thrive.tests.common import BaseCase, HttpCase, tagged
from thrive.tools import topological_sort
from thrive.addons.base.models.assetsbundle import AssetsBundle, WebAsset


_logger = logging.getLogger(__name__)

class TestStaticInheritanceCommon(thrive.tests.TransactionCase):
    def setUp(self):
        super().setUp()
