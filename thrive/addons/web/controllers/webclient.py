...
from thrive.modules import get_manifest, get_resource_path
...
@lazy
def CONTENT_MAXAGE():
    warnings.warn("CONTENT_MAXAGE is a deprecated alias to thrive.http.STATIC_CACHE_LONG", DeprecationWarning)
...
class WebClient(http.Controller):
    ...
    def translations(self, unique, mods=None, lang=None):
        ...
        if mods:
            ...
            mods = list(request.env.registry._init_modules) + (thrive.conf.server_wide_modules or [])
    ...
    def version_info(self):
        return thrive.service.common.exp_version()
