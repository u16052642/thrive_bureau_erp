thrive.define('web.list_tests', function (require) {
"use strict";
...
const { _t } = core;
const { markup, onMounted, onWillUnmount, xml } = require("@thrive/owl");
        ...
        var list = await createView({
            ...
            mockRPC: function (route, args) {
                return this._super.apply(this, arguments).then(result => {
                    ...
                    // (see 5691b126f06/thrive/models.py#L2521-L2528)
        ...
        const list = await createView({
            ...
            mockRPC: function (route, args) {
                if (args.method === 'unlink') {
                    return Promise.reject({ message: "Thrive Bureau ERP server Error" });
                }
                return this._super(...arguments);
            },
        });
