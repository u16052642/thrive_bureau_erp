thrive.define('web.OwlCompatibility', function (require) {
    "use strict";
    ...
    /**
     * This file defines the necessary tools for the transition phase where Thrive
    ...
    const widgetSymbol = thrive.widgetSymbol;
     ...
     * adapter for Owl components that embed Thrive legacy widgets (or dynamically
     * both Owl components and Thrive legacy widgets), e.g.:
     *
     *                           Owl Component
     *                                 |
    ...
    class ComponentAdapter extends LegacyComponent {
        ...
        /**
         * Mocks _trigger_up to redirect Thrive legacy events to OWL events.
         *
         * @private
     ...
     * together when an Thrive legacy widget needs to instantiate Owl components.
    ...
    class ProxyComponent extends LegacyComponent {
         ...
         * Thrive legacy event. This function is called just before the event is
         * actually triggered.
         *
         * @private
         * @param {string} evType
