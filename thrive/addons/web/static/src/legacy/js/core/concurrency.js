thrive.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in Thrive.
 *
 * The basic concurrency primitives in Thrive JS are the callback, and the
...
return {
    ...
    /**
     * A (Thrive) mutex is a primitive for serializing computations.  This is
