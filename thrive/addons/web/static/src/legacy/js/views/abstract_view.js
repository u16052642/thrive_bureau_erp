/** @thrive-module alias=web.AbstractView **/

/**
 * This is the base class inherited by all (JS) views. Thrive JS views are the
 ...
 * the word 'view' has historical significance in Thrive code, so we replaced the
