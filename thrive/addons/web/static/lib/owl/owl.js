(function (exports) {
    ...
    function createCatcher(eventsSpec) {
        ...
        class VCatcher {
            ...
            moveBeforeVNode(other, afterNode) {
                if (other) {
                    // check this with @ged-thrive for use in foreach
...
See https://github.com/thrive/owl/blob/${hash}/doc/reference/app.md#configuration for more information.`;
    };
    ...
    __info__.url = 'https://github.com/thrive/owl';
