...
var DateTimePicker = function ($, moment) {
    ...
    var NAME = 'datetimepicker',
        ...
        Selector = {
        // /!\ THRIVE PATCH: ensure the datetimepickers can be toggled only after
        // the Thrive lazy loader finished loading all lazy scripts. Another
    ...
    var DateTimePicker = function () {
        ...
        DateTimePicker.prototype._change = function _change(e) {
            ...
            this._setValue(parsedDate, 0); // Thrive FIX: if a valid date is replaced by an invalid one, lib will crash, see https://github.com/tempusdominus/bootstrap-4/issues/223
        ...
        DateTimePicker.prototype._notifyEvent = function _notifyEvent(e) {
            // /!\ THRIVE FIX: these next conditions have been modified by thrive
        ...
        DateTimePicker.prototype._getLastPickedDate = function _getLastPickedDate() {
            return this._dates[this._getLastPickedDateIndex()] || this.getMoment(); // FIXME changed by Thrive
        };
...
var TempusDominusBootstrap4 = function ($) {
    ...
    var TempusDominusBootstrap4 = function (_DateTimePicker) {
        ...
        TempusDominusBootstrap4.prototype._place = function _place(e) {
            ...
            // /!\ THRIVE FIX: the 3 next lines have been *added* by thrive
    ...
    */
    ...
    $(document).on(DateTimePicker.Event.CLICK_DATA_API, DateTimePicker.Selector.DATA_TOGGLE, function () {
        ...
        // /!\ THRIVE FIX: check on 'config' existence added by thrive
