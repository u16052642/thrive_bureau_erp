...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("ThriveBeforeTestHook", "ThriveAfterTestHook"); // Thrive customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("ThriveBeforeTestHook"); // Thrive customization
  	...
  	finish: function finish() {
        ...
        emit("ThriveAfterTestHook", this); // Thrive customization
