...

{
    ...
    'version': '1.0',
    'description': """
Thrive Web core module.
========================

This module provides the core of the Thrive Web Client.
""",
    'depends': ['base'],
    'auto_install': True,
    'data': [
    ...
    'assets': {
        ...
        'web.assets_common': [
            ...
            'web/static/lib/thrive_ui_icons/*',
            ...
            'web/static/src/legacy/scss/web.zoomthrive.scss',
            ...
            'web/static/lib/owl/thrive_module.js',
            ...
            'web/static/src/legacy/js/libs/zoomthrive.js',
