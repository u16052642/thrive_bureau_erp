...
from thrive import _, api, fields, models, service
from thrive.exceptions import ValidationError

from thrive.addons.payment_mollie.const import SUPPORTED_CURRENCIES
...
class PaymentProvider(models.Model):
    ...
    def _mollie_make_request(self, endpoint, data=None, method='POST'):
        ...
        thrive_version = service.common.exp_version()['server_version']
        ...
        headers = {
            ...
            "User-Agent": f'Thrive/{thrive_version} MollieNativeThrive/{module_version}',
        }
