...
from thrive.addons.sms.tests import common as sms_common
from thrive.addons.test_mail.tests.test_performance import BaseMailPerformance
...
class TestSMSPerformance(BaseMailPerformance, sms_common.SMSCase):
    ...
    @mute_logger('thrive.addons.sms.models.sms_sms')
    @users('employee')
    @warmup
