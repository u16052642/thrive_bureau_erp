...
from thrive.tools.float_utils import float_repr
from thrive.tools.sql import column_exists, create_column
...
class AccountMove(models.Model):
    ...
    def _l10n_mx_edi_is_managing_invoice_negative_lines_allowed(self):
        ...
        or global discounts. This method allows thrive to distribute the negative discount lines to each others making
        such features available even for Mexican people.

        :return: True if thrive needs to distribute the negative discount lines, False otherwise.
        """
    ...
    def l10n_mx_edi_update_sat_status(self):
        '''Synchronize both systems: Thrive & SAT to make sure the invoice is valid.
        '''
        for move in self:
    ...
    def _l10n_mx_edi_cron_update_sat_status(self):
        ...
        In the second case, the cancellation could be done Thrive-side and then we need to check if the SAT is up-to-date,
        or could be done manually government-side forcing Thrive to update the invoice's state.
        '''
