...
The eBay integrator gives you the opportunity to manage your Thrive's products on eBay.
...
* Automatic creation of sales order and invoices
  ...
  # Check https://github.com/thrive/thrive/blob/master/thrive/addons/base/data/ir_module_category_data.xml
  # for the full list
