thrive.define('account_reports.account_report', function (require) {
'use strict';
...
var accountReportsWidget = AbstractAction.extend({
    ...
    init: function(parent, action) {
        ...
        this.thrive_context = action.context;
    ...
    start: async function() {
        ...
        if("default_filter_accounts" in (this.thrive_context || {}))
            this.$('.o_account_reports_filter_input').val(this.thrive_context.default_filter_accounts).trigger("input");
    },
    parse_report_informations: function(values) {
        ...
        this.thrive_context = values.context;
    ...
    trigger_action: function(e) {
        ...
        var context = new Context(this.thrive_context, params.actionContext || {}, {active_id: id});
