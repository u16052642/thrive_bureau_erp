...
class BankReconciliationReportCustomHandler(models.AbstractModel):
    ...
    def _dynamic_lines_generator(self, report, options, all_column_groups_expression_totals):
        ...
        balance_gl_report_line = {
            ...
            'title_hover': _("The Book balance in Thrive dated today"),
            'columns': [
        ...
        if plus_pay_lines or less_pay_lines:
            ...
            outstanding_payments_report_line = {
                ...
                'title_hover': _("Transactions that were entered into Thrive Bureau ERP, but not yet reconciled (Payments triggered by invoices/bills or manually)"),
                'columns': [
                    {
        ...
        return (
            self._build_section_report_lines(report, options, journal, plus_report_lines, plus_totals,
                ...
                _("%s for Transactions(+) imported from your online bank account (dated today) that "
                  "are not yet reconciled in Thrive (Waiting the final reconciliation allowing finding the right "
    ...
    def _get_payment_report_lines(self, report, options, journal):
        ...
        return (
            self._build_section_report_lines(report, options, journal, plus_report_lines, plus_totals,
                ...
                _("Transactions(+) that were entered into Thrive Bureau ERP, but not yet reconciled (Payments triggered by "
