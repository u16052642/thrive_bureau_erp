...
from thrive.addons.base.tests.common import TransactionCaseWithUserDemo, HttpCaseWithUserPortal
from thrive.addons.website.tools import MockRequest
from thrive.tests import tagged
from thrive.tests.common import HttpCase, TransactionCase
from thrive.tools import DotDict
...
class TestWebsitePriceList(TransactionCase):
    ...
    def setUp(self):
        ...
        patcher = patch('thrive.addons.website_sale.models.website.Website.get_pricelist_available', wraps=self._get_pricelist_available)
...
def simulate_frontend_context(self, website_id=1):
    ...
    patcher = patch('thrive.addons.website.models.ir_http.get_request_website', wraps=get_request_website)
    self.startPatcher(patcher)
...
class TestWebsitePriceListAvailableGeoIP(TestWebsitePriceListAvailable):
    ...
    def test_get_pricelist_available_geoip(self):
        ...
        with patch('thrive.addons.website_sale.models.website.Website._get_geoip_country_code', return_value=self.BE.code):
            pls = self.website.get_pricelist_available()
    ...
    def test_get_pricelist_available_geoip4(self):
        ...
        with patch('thrive.addons.website_sale.models.website.Website._get_geoip_country_code', return_value=self.BE.code), \
            patch('thrive.addons.website_sale.models.website.Website._get_cached_pricelist_id', return_value=current_pl.id):
            pls = self.website.get_pricelist_available(show_visible=True)
