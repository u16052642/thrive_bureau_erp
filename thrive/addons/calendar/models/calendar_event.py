...
from thrive.addons.base.models.res_partner import _tz_get
from thrive.addons.calendar.models.calendar_attendee import Attendee
from thrive.addons.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from thrive.tools import pycompat, html2plaintext, is_html_empty, single_email_re
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'Thrive'
