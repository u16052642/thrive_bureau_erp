...
from thrive import api, models, fields, _, tools
from thrive.exceptions import UserError
from thrive.tools import pdf, float_repr
from thrive.tools.safe_eval import const_eval
...
class ProviderFedex(models.Model):
    ...
    fedex_weight_unit = fields.Selection([('LB', 'LB'),
                                          ('KG', 'KG')],
                                         default='LB')
    # Note about weight units: Thrive (v9) currently works with kilograms.
