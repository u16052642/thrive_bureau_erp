...
from thrive.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('thrive.models', 'thrive.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('thrive.models.unlink', 'thrive.addons.base.models.ir_rule', 'thrive.addons.base.models.ir_model')
