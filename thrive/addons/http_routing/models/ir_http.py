...
import thrive
from thrive import api, models, exceptions, tools, http
from thrive.addons.base.models import ir_http
from thrive.addons.base.models.ir_http import RequestUID
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        if request.is_frontend_multilang:
            ...
            if request.httprequest.method in ('GET', 'HEAD'):
                ...
                except thrive.exceptions.MissingError:
