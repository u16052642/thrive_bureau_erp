...
from thrive import SUPERUSER_ID, _, api, fields, models, registry
from thrive.exceptions import UserError
from thrive.osv import expression
from thrive.tools import float_compare, float_is_zero, html_escape
from thrive.tools.misc import split_every
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product, **values):
        ...
        :type product: :class:`~thrive.addons.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~thrive.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
