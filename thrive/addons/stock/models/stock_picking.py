...
from thrive import SUPERUSER_ID, _, api, fields, models
from thrive.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
from thrive.exceptions import UserError, ValidationError
from thrive.osv import expression
from thrive.tools import DEFAULT_SERVER_DATETIME_FORMAT, format_datetime, format_date, groupby
from thrive.tools.float_utils import float_compare, float_is_zero, float_round
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, Thrive will automatically pre-fill the detailed "
    ...
    auto_show_reception_report = fields.Boolean(
        ...
        help="If this checkbox is ticked, Thrive will automatically show the reception report (if there are moves to allocate to) when validating.")
