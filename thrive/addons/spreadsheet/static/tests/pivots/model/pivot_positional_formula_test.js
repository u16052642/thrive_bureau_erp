...
QUnit.module("spreadsheet > positional pivot formula", {}, () => {
    QUnit.test("Can have positional args in pivot formula", async function (assert) {
        ...
        // Columns
        setCellContent(model, "H1", `=THRIVE.PIVOT(1,"probability","#foo", 1)`);
        setCellContent(model, "H2", `=THRIVE.PIVOT(1,"probability","#foo", 2)`);
        setCellContent(model, "H3", `=THRIVE.PIVOT(1,"probability","#foo", 3)`);
        setCellContent(model, "H4", `=THRIVE.PIVOT(1,"probability","#foo", 4)`);
        setCellContent(model, "H5", `=THRIVE.PIVOT(1,"probability","#foo", 5)`);
        ...
        // Rows
        setCellContent(model, "I1", `=THRIVE.PIVOT(1,"probability","#bar", 1)`);
        setCellContent(model, "I2", `=THRIVE.PIVOT(1,"probability","#bar", 2)`);
        setCellContent(model, "I3", `=THRIVE.PIVOT(1,"probability","#bar", 3)`);
    ...
    QUnit.test("Can have positional args in pivot headers formula", async function (assert) {
        const { model } = await createSpreadsheetWithPivot();
        // Columns
        setCellContent(model, "H1", `=THRIVE.PIVOT.HEADER(1,"#foo",1)`);
        setCellContent(model, "H2", `=THRIVE.PIVOT.HEADER(1,"#foo",2)`);
        setCellContent(model, "H3", `=THRIVE.PIVOT.HEADER(1,"#foo",3)`);
        setCellContent(model, "H4", `=THRIVE.PIVOT.HEADER(1,"#foo",4)`);
        setCellContent(model, "H5", `=THRIVE.PIVOT.HEADER(1,"#foo",5)`);
        setCellContent(model, "H6", `=THRIVE.PIVOT.HEADER(1,"#foo",5, "measure", "probability")`);
        ...
        // Rows
        setCellContent(model, "I1", `=THRIVE.PIVOT.HEADER(1,"#bar",1)`);
        setCellContent(model, "I2", `=THRIVE.PIVOT.HEADER(1,"#bar",2)`);
        setCellContent(model, "I3", `=THRIVE.PIVOT.HEADER(1,"#bar",3)`);
        setCellContent(model, "I4", `=THRIVE.PIVOT.HEADER(1,"#bar",3, "measure", "probability")`);
    ...
    QUnit.test("pivot positional with two levels of group bys in rows", async (assert) => {
        ...
        // Rows Headers
        setCellContent(model, "H1", `=THRIVE.PIVOT.HEADER(1,"bar","false","#product_id",1)`);
        setCellContent(model, "H2", `=THRIVE.PIVOT.HEADER(1,"bar","true","#product_id",1)`);
        setCellContent(model, "H3", `=THRIVE.PIVOT.HEADER(1,"#bar",1,"#product_id",1)`);
        setCellContent(model, "H4", `=THRIVE.PIVOT.HEADER(1,"#bar",2,"#product_id",1)`);
        setCellContent(model, "H5", `=THRIVE.PIVOT.HEADER(1,"#bar",3,"#product_id",1)`);
        ...
        setCellContent(
            model,
            "H1",
            `=THRIVE.PIVOT(1,"probability","#bar",1,"#product_id",1,"#foo",2)`
        );
        setCellContent(
            model,
            "H2",
            `=THRIVE.PIVOT(1,"probability","#bar",1,"#product_id",2,"#foo",2)`
        );
    ...
    QUnit.test("Positional argument without a number should crash", async (assert) => {
        const { model } = await createSpreadsheetWithPivot();
        setCellContent(model, "A10", `=THRIVE.PIVOT.HEADER(1,"#bar","this is not a number")`);
        assert.strictEqual(getCellValue(model, "A10"), "#ERROR");
        assert.strictEqual(
            getCell(model, "A10").evaluated.error.message,
            "The function THRIVE.PIVOT.HEADER expects a number value, but 'this is not a number' is a string, and cannot be coerced to a number."
        );
    });
    ...
    QUnit.test("sort first pivot column (ascending)", async (assert) => {
        ...
        setCellContent(model, "A1", `=THRIVE.PIVOT.HEADER(1,"#bar",1)`);
        setCellContent(model, "A2", `=THRIVE.PIVOT.HEADER(1,"#bar",2)`);
        setCellContent(model, "B1", `=THRIVE.PIVOT(1,"probability","#bar",1,"#foo",1)`);
        setCellContent(model, "B2", `=THRIVE.PIVOT(1,"probability","#bar",2,"#foo",1)`);
        setCellContent(model, "C1", `=THRIVE.PIVOT(1,"probability","#bar",1,"#foo",2)`);
        setCellContent(model, "C2", `=THRIVE.PIVOT(1,"probability","#bar",2,"#foo",2)`);
        setCellContent(model, "D1", `=THRIVE.PIVOT(1,"probability","#bar",1)`);
        setCellContent(model, "D2", `=THRIVE.PIVOT(1,"probability","#bar",2)`);
    ...
    QUnit.test("sort second pivot measure (ascending)", async (assert) => {
        ...
        const model = await createModelWithDataSource({ spreadsheetData });
        setCellContent(model, "A10", `=THRIVE.PIVOT.HEADER(1,"#product_id",1)`);
        setCellContent(model, "A11", `=THRIVE.PIVOT.HEADER(1,"#product_id",2)`);
        setCellContent(model, "B10", `=THRIVE.PIVOT(1,"probability","#product_id",1)`);
        setCellContent(model, "B11", `=THRIVE.PIVOT(1,"probability","#product_id",2)`);
        setCellContent(model, "C10", `=THRIVE.PIVOT(1,"foo","#product_id",1)`);
        setCellContent(model, "C11", `=THRIVE.PIVOT(1,"foo","#product_id",2)`);
        await waitForDataSourcesLoaded(model);
    ...
    QUnit.test("Formatting a pivot positional preserves the interval", async (assert) => {
        ...
        setCellContent(model, "A1", `=THRIVE.PIVOT.HEADER(1,"#date:day",1)`);
