...
export default class ListUIPlugin extends spreadsheet.UIPlugin {
    ...
    handle(cmd) {
        switch (cmd.type) {
            case "SELECT_THRIVE_LIST":
                this._selectList(cmd.listId);
                break;
            case "REFRESH_THRIVE_LIST":
                this._refreshThriveList(cmd.listId);
                break;
            case "REFRESH_ALL_DATA_SOURCES":
                this._refreshThriveLists();
                break;
    ...
    _refreshThriveLists() {
        for (const listId of this.getters.getListIds()) {
            this._refreshThriveList(listId);
        }
    }
