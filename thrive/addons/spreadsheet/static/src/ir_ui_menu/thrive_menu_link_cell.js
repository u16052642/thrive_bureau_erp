...
const VIEW_PREFIX = "thrive://view/";
const IR_MENU_ID_PREFIX = "thrive://ir_menu_id/";
const IR_MENU_XML_ID_PREFIX = "thrive://ir_menu_xml_id/";
...
export class ThriveMenuLinkCell extends LinkCell {
...
export class ThriveViewLinkCell extends LinkCell {
    /**
     *
     * @param {string} id
