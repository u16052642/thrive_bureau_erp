...
coreTypes.add("RENAME_THRIVE_PIVOT");
coreTypes.add("REMOVE_PIVOT");
coreTypes.add("RE_INSERT_PIVOT");
coreTypes.add("UPDATE_THRIVE_PIVOT_DOMAIN");

invalidateEvaluationCommands.add("UPDATE_THRIVE_PIVOT_DOMAIN");
...
inverseCommandRegistry
    ...
    .add("RENAME_THRIVE_PIVOT", identity)
    .add("REMOVE_PIVOT", identity)
    .add("UPDATE_THRIVE_PIVOT_DOMAIN", identity)
