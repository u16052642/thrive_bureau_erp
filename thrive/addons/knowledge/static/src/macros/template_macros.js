    ...
    macroAction() {
        ...
        action.steps.push({
            ...
            trigger: function () {
                ...
                if (dialog) {
                    return this.getFirstVisibleElement(dialog.querySelector('.o_field_html[name="body"] > .thrive-editor-editable'));
                }
                return null;
            }.bind(this),
...
export class UseAsDescriptionMacro extends AbstractMacro {
    ...
    macroAction() {
        ...
        action.steps.push({
            ...
            trigger: function () {
                this.validatePage();
                return this.getFirstVisibleElement(`.o_field_html[name="${this.data.fieldName}"] > .thrive-editor-editable`);
            }.bind(this),
            action: function (el) {
