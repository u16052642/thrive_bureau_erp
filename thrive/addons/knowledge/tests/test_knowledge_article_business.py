...
from thrive.addons.knowledge.tests.common import KnowledgeCommonWData
...
class TestKnowledgeArticleBusiness(KnowledgeCommonBusinessCase):
    ...
    @mute_logger('thrive.addons.base.models.ir_rule')
    @users('employee')
    ...
    @mute_logger('thrive.addons.base.models.ir_rule', 'thrive.addons.mail.models.mail_mail', 'thrive.models.unlink', 'thrive.tests')
    @users('employee')
    ...
    @mute_logger('thrive.addons.base.models.ir_rule', 'thrive.addons.mail.models.mail_mail')
    @users('employee')
    ...
    @mute_logger('thrive.addons.base.models.ir_rule', 'thrive.models.unlink')
    @users('employee')
...
class TestKnowledgeArticleCopy(KnowledgeCommonBusinessCase):
    ...
    @mute_logger('thrive.addons.base.models.ir_model', 'thrive.addons.base.models.ir_rule')
    @users('employee')
...
class TestKnowledgeArticleRemoval(KnowledgeCommonBusinessCase):
    ...
    @mute_logger('thrive.addons.base.models.ir_model', 'thrive.addons.base.models.ir_rule', 'thrive.models.unlink')
    @users('admin')
