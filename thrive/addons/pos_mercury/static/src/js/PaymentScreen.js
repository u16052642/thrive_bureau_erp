thrive.define('pos_mercury.PaymentScreen', function (require) {
    'use strict';
    ...
    const PosMercuryPaymentScreen = (PaymentScreen) =>
        class extends PaymentScreen {
            setup() {
                ...
                // How long we wait for the thrive server to deliver the response of
                ...
                this.rpc(
                    ...
                    .then(function (data) {
                        ...
                        if (data === 'internal error') {
                            def.resolve({
                                message: self.env._t('Thrive error while processing transaction.'),
                            });
                            return;
                        }
