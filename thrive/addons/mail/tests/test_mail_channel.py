...
from thrive.addons.mail.models.mail_channel import channel_avatar, group_avatar
...
from thrive.tests import tagged, Form
from thrive.tests.common import users
from thrive.tools import html_escape, mute_logger
from thrive.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
...
class TestChannelAccessRights(MailCommon):
    ...
    @mute_logger('thrive.addons.base.models.ir_rule', 'thrive.addons.base.models.ir_model', 'thrive.models')
    @users('user_public')
