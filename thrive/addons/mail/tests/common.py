...
from thrive.addons.bus.models.bus import ImBus, json_dump
from thrive.addons.mail.models.mail_mail import MailMail
from thrive.addons.mail.models.mail_message import Message
from thrive.addons.mail.models.mail_notification import MailNotification
from thrive.tests import common, new_test_user
from thrive.tools import formataddr, mute_logger, pycompat
from thrive.tools.translate import code_translations
...
class MailCommon(common.TransactionCase, MailCase):
    ...
    def _activate_multi_lang(cls, lang_code='es_ES', layout_arch_db=None, test_record=False, test_template=False):
        ...
        with mute_logger("thrive.addons.base.models.ir_module", "thrive.tools.translate"):
