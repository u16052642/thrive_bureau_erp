...
from thrive import _, api, exceptions, fields, models, modules, tools
from thrive.addons.base.models.res_users import is_selection_groups
...
class Users(models.Model):
    ...
    _sql_constraints = [(
        ...
        "Only internal user can receive notifications in Thrive",
    )]

    @api.depends('share')
    def _compute_notification_type(self):
        for user in self:
            # Only the internal users can receive notifications in Thrive
