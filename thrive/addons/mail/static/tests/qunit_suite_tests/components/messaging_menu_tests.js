...
QUnit.test('rendering with ThriveBot has a request (default)', async function (assert) {
    assert.expect(4);
    ...
    assert.ok(
        ...
        "should display a notification counter next to the messaging menu for ThriveBot request"
    );
    assert.strictEqual(
        document.querySelector('.o_MessagingMenu_counter').textContent,
        "1",
    ...
    assert.strictEqual(
        ...
        'ThriveBot has a request',
        "notification should display that ThriveBot has a request"
    );
});

QUnit.test('rendering without ThriveBot has a request (denied)', async function (assert) {
    assert.expect(2);
...
QUnit.test('rendering without ThriveBot has a request (accepted)', async function (assert) {
    assert.expect(2);
