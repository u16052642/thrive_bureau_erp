...
from thrive.addons.appointment.tests.test_performance import AppointmentUIPerformanceCase
from thrive.addons.appointment_hr.tests.test_performance import AppointmenHrPerformanceCase
