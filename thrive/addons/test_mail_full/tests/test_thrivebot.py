...
@tagged("thrivebot")
class TestThrivebot(TestMailCommon, TestRecipients):
    ...
    def test_fetch_listener(self):
        ...
        thrivebot_in_fetch_listeners = self.env['mail.channel.member'].search([('channel_id', '=', channel.id), ('partner_id', '=', thrivebot.id)])
