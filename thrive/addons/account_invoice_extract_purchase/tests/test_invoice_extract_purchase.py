...
from thrive.addons.account_invoice_extract.models.account_invoice import SUCCESS
...
from thrive.tests.common import Form
...
class TestInvoiceExtractPurchase(AccountTestInvoicingCommon, account_invoice_extract_common.MockIAP):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.vendor = cls.env['res.partner'].create({'name': 'Thrive', 'vat': 'BE0477472701'})
