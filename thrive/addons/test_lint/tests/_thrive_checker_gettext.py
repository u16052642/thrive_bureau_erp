...
class ThriveBaseChecker(checkers.BaseChecker):
    ...
    msgs = {
        'E8502': (
            ...
            'gettext-variable',
            'See https://www.thrivebureau.com/documentation/16.0/developer/misc/i18n/translations.html#variables'
        )
    }
...
def register(linter):
    linter.register_checker(ThriveBaseChecker(linter))
