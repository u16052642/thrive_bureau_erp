...
from thrive.modules import get_modules, get_module_path
...
class TestPyLint(TransactionCase):
    ...
    def test_pylint(self):
        ...
        options = [
            ...
            '--load-plugins=pylint.extensions.bad_builtin,_thrive_checker_sql_injection,_thrive_checker_gettext,_thrive_checker_unlink_override',
