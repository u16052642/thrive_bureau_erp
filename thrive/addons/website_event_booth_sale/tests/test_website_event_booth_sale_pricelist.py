...
from thrive.addons.event_booth_sale.tests.common import TestEventBoothSaleCommon
from thrive.addons.website_event_sale.tests.common import TestWebsiteEventSaleCommon
