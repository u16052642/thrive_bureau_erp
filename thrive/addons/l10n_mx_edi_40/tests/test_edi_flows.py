...
from thrive.addons.account_edi.tests.common import _mocked_cancel_success
...
class TestEdiFlows(TestMxEdiCommon):
    ...
    def test_invoice_flow_not_sent(self):
        with freeze_time(self.frozen_today), \
             patch('thrive.addons.l10n_mx_edi.models.account_edi_format.AccountEdiFormat._l10n_mx_edi_post_invoice_pac',
    ...
    def test_invoice_flow_sent_twice(self):
        with freeze_time(self.frozen_today), \
             patch('thrive.addons.l10n_mx_edi.models.account_edi_format.AccountEdiFormat._l10n_mx_edi_post_invoice_pac',
                   new=mocked_l10n_mx_edi_pac), \
             patch('thrive.addons.l10n_mx_edi.models.account_edi_format.AccountEdiFormat._l10n_mx_edi_cancel_invoice',
    ...
    def test_payment_flow_PUE_invoice(self):
        with freeze_time(self.frozen_today), \
             patch('thrive.addons.l10n_mx_edi.models.account_edi_format.AccountEdiFormat._l10n_mx_edi_post_invoice_pac',
                   new=mocked_l10n_mx_edi_pac), \
             patch('thrive.addons.l10n_mx_edi.models.account_edi_format.AccountEdiFormat._l10n_mx_edi_post_payment_pac',
                   new=mocked_l10n_mx_edi_pac):
    ...
    def test_payment_flow_unreconcile(self):
        with freeze_time(self.frozen_today), \
             ...
             patch('thrive.addons.l10n_mx_edi.models.account_edi_format.AccountEdiFormat._l10n_mx_edi_post_payment_pac',
                   new=mocked_l10n_mx_edi_pac), \
             patch('thrive.addons.l10n_mx_edi.models.account_edi_format.AccountEdiFormat._l10n_mx_edi_cancel_payment',
                   new=_mocked_cancel_success):
            self.payment.action_post()
            self.invoice.action_post()
