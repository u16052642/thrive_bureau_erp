thrive.define('account.ReconciliationRenderer', function (require) {
"use strict";
 ...
 */
var ManualRenderer = Widget.extend(FieldManagerMixin, {
 ...
 * view for 'match' mode
 */
var ManualLineRenderer = Widget.extend(FieldManagerMixin, {
