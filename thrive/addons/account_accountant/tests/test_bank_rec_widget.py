# -*- coding: utf-8 -*-
from thrive.addons.account_accountant.tests.test_bank_rec_widget_common import TestBankRecWidgetCommon, WizardForm
...
class TestBankRecWidget(TestBankRecWidgetCommon):
    ...
    def test_validation_new_aml_same_foreign_currency(self):
        ...
        # 6000.0 curr2 == 1200.0 comp_curr (bank rate 5:1 instead of the thrive rate 4:1)
    ...
    def test_validation_new_aml_multi_currencies(self):
        # 6300.0 curr2 == 1800.0 comp_curr (bank rate 3.5:1 instead of the thrive rate 4:1)
        st_line = self._create_st_line(
            1800.0,
            date='2017-01-01',
            foreign_currency_id=self.currency_data_2['currency'].id,
