...
from thrive.addons.test_mail_full.tests.common import TestMailFullCommon
...
class TestMACommon(TestMailFullCommon):
    ...
    def setUpClass(cls):
        ...
        cls.patcher = patch('thrive.addons.marketing_automation.models.marketing_campaign.Datetime', wraps=Datetime)
        cls.patcher2 = patch('thrive.addons.marketing_automation.models.marketing_activity.Datetime', wraps=Datetime)
        cls.patcher3 = patch('thrive.addons.marketing_automation.models.marketing_participant.Datetime', wraps=Datetime)
        cls.patcher4 = patch('thrive.addons.marketing_automation.models.marketing_trace.Datetime', wraps=Datetime)
        cls.patcher5 = patch('thrive.addons.marketing_automation_sms.models.marketing_activity.Datetime', wraps=Datetime)
