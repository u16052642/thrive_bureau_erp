...
from thrive.addons.test_marketing_automation.tests.common import TestMACommon
...
for record in records:
    ...
    @mute_logger('thrive.addons.base.models.ir_model', 'thrive.addons.mail.models.mail_mail')
    @users('user_markauto')
