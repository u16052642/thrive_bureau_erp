thrive.define('l10n_ke_edi_tremol.action_post_send_invoice', function (require) {
        ...
        await ajax.post(params.proxy_address + '/hw_proxy/l10n_ke_cu_send', params).then(function (res) {
            ...
            if (res_obj.status != "ok") {
                ...
                rpc.query({
                    ...
                    Dialog.alert(this, _t("Error trying to connect to Thrive Bureau ERP. Check your internet connection"));
                })
            }
        }, function () {
