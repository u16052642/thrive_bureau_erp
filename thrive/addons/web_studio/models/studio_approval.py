...
class StudioApprovalRule(models.Model):
    ...
    def set_approval(self, res_id, approved):
        ...
        :rtype: boolean
        :raise: thrive.exceptions.AccessError when the user does not have write
                access to the underlying record
        :raise: thrive.exceptions.UserError when any of the other checks failed
        """
        self.ensure_one()
    ...
    def delete_approval(self, res_id):
        ...
        :raise: thrive.exceptions.AccessError when the user does not have write
                access to the underlying record
        :raise: thrive.exceptions.UserError when any there is no existing entry
    ...
    def _set_approval(self, res_id, approved):
        ...
        :rtype: :class:`~thrive.addons.web_studio.models.StudioApprovalEntry`
        :raise: thrive.exceptions.AccessError when the user does not have write
                access to the underlying record
        :raise: thrive.exceptions.UserError when any of the other checks failed
        """
        ...
        # Thrive itself (not PG); the NOWAIT ensures that no deadlock will happen
