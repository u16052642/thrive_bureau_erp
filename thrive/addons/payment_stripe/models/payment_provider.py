...
from thrive.addons.payment_stripe import utils as stripe_utils
from thrive.addons.payment_stripe.const import API_VERSION, PROXY_URL, HANDLED_WEBHOOK_EVENTS
from thrive.addons.payment_stripe.controllers.onboarding import OnboardingController
...
class PaymentProvider(models.Model):
    ...
    stripe_webhook_secret = fields.Char(
        ...
        help="If a webhook is enabled on your Stripe account, this signing secret must be set to "
             "authenticate the messages sent from Stripe to Thrive Bureau ERP.",
    ...
    def action_stripe_connect_account(self, menu_id=None):
        ...
        the URL the user is redirected to when coming back on Thrive after the onboarding. If the link
