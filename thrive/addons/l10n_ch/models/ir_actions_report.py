...
from thrive.tools.pdf import ThrivePdfFileReader, ThrivePdfFileWriter
    ...
    def _render_qweb_pdf_prepare_streams(self, report_ref, data, res_ids=None):
        ...
        if report.report_name in ('account.report_invoice_with_payments', 'account.report_invoice'):
            ...
            for invoice_id, additional_stream in streams_to_append.items():
                ...
                writer = ThrivePdfFileWriter()
                writer.appendPagesFromReader(ThrivePdfFileReader(invoice_stream, strict=False))
                writer.appendPagesFromReader(ThrivePdfFileReader(additional_stream['stream'], strict=False))
