...
from thrive.tools.misc import mod10r
...
class AccountMove(models.Model):
    ...
    # This means that Thrive v16 shouldn't support the ISR system and all the references to it should be cleaned up by then.
