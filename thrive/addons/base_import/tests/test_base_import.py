...
from thrive.tests.common import TransactionCase, can_import
from thrive.modules.module import get_module_resource
from thrive.tools import mute_logger, pycompat
from thrive.addons.base_import.models.base_import import ImportValidationError
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('thrive.addons.base_import.models.base_import')
