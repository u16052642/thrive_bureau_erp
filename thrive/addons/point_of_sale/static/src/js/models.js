...
thrive.define('point_of_sale.models', function (require) {
"use strict";
...
class PosGlobalState extends PosModel {
   ...
   async _processData(loadedData) {
    ...
    _loadPosSession() {
        ...
        this.pos_session.login_number = thrive.login_number;
    }
    _loadPoSConfig() {
    ...
    load_new_partners(){
        return new Promise((resolve, reject)  => {
            ...
            this.env.services.rpc({
                ...
                args: [[thrive.pos_session_id], {domain}],
            }, {
                timeout: 3000,
                shadow: true,
            })
    ...
    async _loadMissingProducts(orders) {
        ...
        const products = await this.env.services.rpc({
            ...
            args: [thrive.pos_session_id, {domain: [['id', 'in', [...missingProductIds]]]}],
        });
    ...
    async _addProducts(ids, setAvailable=true){
        ...
        let product = await this.env.services.rpc({
            model: 'pos.session',
            method: 'get_pos_ui_product_product_by_params',
            args: [thrive.pos_session_id, {domain: [['id', 'in', ids]]}],
        });
