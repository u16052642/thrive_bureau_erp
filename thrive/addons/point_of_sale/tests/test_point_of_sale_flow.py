...
import thrive
from thrive import fields, tools
from thrive.tools import float_compare, mute_logger, test_reports
from thrive.tests.common import Form
from thrive.addons.point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('thrive.addons.point_of_sale.models.pos_order'):
