...
from thrive.tools.pdf import ThrivePdfFileReader
from thrive.osv import expression
from thrive.tools import html_escape
from thrive.exceptions import RedirectWarning
...
class AccountEdiFormat(models.Model):
    ...
    def _create_invoice_from_pdf_reader(self, filename, reader):
        ...
        :param reader:   The ThrivePdfFileReader of the pdf to import.
        :returns:        The created invoice.
        """
        # TO OVERRIDE
        self.ensure_one()
    ...
    def _decode_pdf(self, filename, content):
        ...
        * pdf_reader:       The pdf_reader if type is pdf.
        ...
        try:
            ...
            pdf_reader = ThrivePdfFileReader(buffer, strict=False)
        except Exception as e:
            # Malformed pdf
