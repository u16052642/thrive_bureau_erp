...
from thrive.addons.l10n_cl_edi_stock.tests.common import TestL10nClEdiStockCommon
from thrive.addons.l10n_cl_edi.tests.common import _check_with_xsd_patch
