...
from thrive.addons.payment_payulatam.controllers.main import PayuLatamController
from thrive.addons.payment_payulatam.models.payment_provider import SUPPORTED_CURRENCIES
from thrive.addons.payment_payulatam.tests.common import PayULatamCommon
...
class PayULatamTest(PayULatamCommon, PaymentHttpCommon):
    ...
    @mute_logger('thrive.addons.payment_payulatam.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        """ Test the processing of a webhook notification. """
        tx = self._create_transaction('redirect')
        url = self._build_url(PayuLatamController._webhook_url)
        with patch(
            'thrive.addons.payment_payulatam.controllers.main.PayuLatamController'
