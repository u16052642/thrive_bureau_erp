...
QUnit.module('invoice_extract_form_view_tests.js', {
    ...
    QUnit.test('basic', async function (assert) {
        ...
        const resPartnerId1 = pyEnv['res.partner'].create({ name: "Thrive", vat: "BE0477472701" });
        ...
        assert.strictEqual(document.querySelector('.o_field_widget[name=partner_id] input').value, "Thrive",
            "partner_id field should be set to Thrive Bureau ERP");
