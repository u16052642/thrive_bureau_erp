...
from thrive import api, models, fields, _, _lt
from thrive.exceptions import UserError
from thrive.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
from thrive.addons.l10n_it_edi.tools.remove_signature import remove_signature
from thrive.osv.expression import OR, AND
...
class AccountEdiFormat(models.Model):
    ...
    def _prepare_invoice_report(self, pdf_writer, edi_document):
        ...
        if edi_document.attachment_id:
            pdf_writer.embed_thrive_attachment(edi_document.attachment_id)
        ...
        for invoice in invoices:
            ...
            if invoice._is_commercial_partner_pa():
                invoice.message_post(
                    body=(_("Invoices for PA are not managed by Thrive, you can download the document and send it on your own."))
                )
            ...
            if state == 'ricevutaConsegna':
                ...
                if invoice._is_commercial_partner_pa():
                    to_return[invoice] = {'error': _(
                        ...
                        ' Should this also fail, the System will notify Thrive of the failed delivery,'
