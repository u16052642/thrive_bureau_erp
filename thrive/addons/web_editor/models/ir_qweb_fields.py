...
Also, adds methods to convert values back to Thrive Bureau ERP models.
"""
...
from thrive import _, api, models, fields
from thrive.exceptions import UserError, ValidationError
from thrive.tools import ustr, posix_to_ldml, pycompat
from thrive.tools import html_escape as escape
from thrive.tools.misc import get_lang, babel_locale_parse
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = thrive.modules.get_module_resource(
