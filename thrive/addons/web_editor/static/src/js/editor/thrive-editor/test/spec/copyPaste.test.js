...
import {CLIPBOARD_WHITELISTS} from "../../src/ThriveEditor.js";
...
const pasteThriveEditorHtml = async (editor, html) => pasteData(editor, html, 'text/thrive-editor');
...
describe('Copy and paste', () => {
        ...
        describe('range collapsed', async () => {
            it('should paste and transform an image URL in a p', async () => {
                await testEditor(BasicEditor, {
                    contentBefore: '<p>ab[]cd</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'https://download.thrivecdn.com/icons/website/static/description/icon.png');
                    ...
                    contentAfter: '<p>ab<img src="https://download.thrivecdn.com/icons/website/static/description/icon.png">[]cd</p>',
                });
            });
            it('should paste and transform an image URL in a span', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p>a<span>b<img src="https://download.thrivecdn.com/icons/website/static/description/icon.png">[]c</span>d</p>',
                });
            });
            it('should paste and transform an image URL in an existing link', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p>a<a href="http://existing.com">b<img src="https://download.thrivecdn.com/icons/website/static/description/icon.png">[]c</a>d</p>',
                });
            });
        });
        describe('range not collapsed', async () => {
    ...
    describe('Thrive editor own html', () => {
        it('should paste html as is', async () => {
            await testEditor(BasicEditor, {
                contentBefore: '<p>a[]b</p>',
                stepFunction: async editor => {
                    await pasteThriveEditorHtml(editor, '<div class="custom-paste">b</div>');
                },
        ...
        it('should not paste unsafe content', async () => {
            await testEditor(BasicEditor, {
                contentBefore: '<p>a[]b</p>',
                stepFunction: async editor => {
                    await pasteThriveEditorHtml(editor, `<script>console.log('xss attack')</script>`);
                },
