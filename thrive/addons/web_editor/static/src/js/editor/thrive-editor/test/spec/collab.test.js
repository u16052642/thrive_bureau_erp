import { ThriveEditor } from '../../src/ThriveEditor.js';
import {
    insertCharsAt,
...
const testMultiEditor = spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        ThriveEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new ThriveEditor(clientInfo.editable, {
            toSanitize: false,
    ...
    ThriveEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
