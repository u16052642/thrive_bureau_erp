thrive.define('web_editor.test_utils', function (require) {
"use strict";

var ajax = require('web.ajax');
var MockServer = require('web.MockServer');
var testUtils = require('web.test_utils');
var ThriveEditorLib = require('@web_editor/js/editor/thrive-editor/src/ThriveEditor');
...
var testKeyboard = function ($editable, assert, keyboardTests, addTests) {
    ...
    function nextPoint(point) {
        var node, offset;
        if (ThriveEditorLib.nodeSize(point.node) === point.offset) {
            node = point.node.parentNode;
            offset = ThriveEditorLib.childNodeIndex(point.node) + 1;
