...
from thrive.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import ValuationReconciliationTestCommon
from thrive.tests import common, Form
from thrive.exceptions import UserError
from thrive.tools import mute_logger, float_compare
from thrive.addons.stock_account.tests.test_stockvaluation import _create_accounting_data
...
class TestSaleMrpFlow(ValuationReconciliationTestCommon):
    ...
    @mute_logger('thrive.tests.common.onchange')
