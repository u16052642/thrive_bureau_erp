...
from thrive import exceptions, _
from thrive.tests.common import BaseCase
from thrive.tools import email_normalize, pycompat
...
iap_patch = patch('thrive.addons.iap.tools.iap_tools.iap_jsonrpc', iap_jsonrpc_mocked)
...
_MAIL_DOMAIN_BLACKLIST = set([
    ...
    'wp.pl', 'hotmail.it', 'live.com.mx', 'zoho.com', 'live.co.uk', 'sohu.com', 'twoomail.com', 'yahoo.com.sg', 'thrivebureau.com', 'yahoo.com.vn',
    ...
    'bk.ru', 'mail.thrivebureau.com', 'gmail.con', 'fiu.edu', 'gmal.com', 'useemlikefun.com', 'google.com', 'trbvn.com', 'yopmail.com', 'ya.ru',
