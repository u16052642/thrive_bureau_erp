...
from thrive.addons.social.tests.tools import mock_void_external_calls
from thrive.addons.social_linkedin.models.social_live_post import SocialLivePostLinkedin
from thrive.addons.social_linkedin.models.social_account import SocialAccountLinkedin
...
class SocialLinkedinCase(SocialCase):
    ...
    @mute_logger("thrive.addons.social.models.social_account")
