...
from thrive import registry as registry_get

from thrive.addons.auth_signup.controllers.main import AuthSignupHome as Home
from thrive.addons.web.controllers.utils import ensure_db, _get_login_redirect_url
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via Thrive Account provider"""
