...
from thrive import _, models, fields, api
...
class SocialAccount(models.Model):
    ...
    social_account_handle = fields.Char("Handle / Short Name",
        help="Contains the social media handle of the person that created this account. E.g: '@thrive.official' for the 'Thrive' Twitter account")
    ...
    def _compute_stats_link(self):
        ...
        Ex: https://www.facebook.com/Thrive-Social-557894618055440/insights """
        for account in self:
            account.stats_link = False

    def name_get(self):
        """ ex: [Facebook] Thrive Social, [Twitter] Mitchell Admin, ... """
