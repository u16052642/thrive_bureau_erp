...
class SocialMedia(models.Model):
    ...
    Ex: Thrive Social Facebook Page, Mitchell Admin Twitter Account, ...
    ...
    _DEFAULT_SOCIAL_IAP_ENDPOINT = 'https://social.api.thrivebureau.com'
