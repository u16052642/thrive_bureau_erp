...
import { buildIrMenuIdLink, buildViewLink, buildIrMenuXmlLink } from "@spreadsheet/ir_ui_menu/thrive_menu_link_cell"
 ...
 * @param {import("@spreadsheet/ir_ui_menu/thrive_menu_link_cell").ViewLinkDescription} actionToLink
...
linkMenuRegistry.add("thriveMenu", {
    name: _lt("Link an Thrive menu"),
    sequence: 20,
    action: async (env) => {
