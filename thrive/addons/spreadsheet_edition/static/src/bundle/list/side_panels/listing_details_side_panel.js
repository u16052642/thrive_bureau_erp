...
export class ListingDetailsSidePanel extends Component {
    ...
    onNameChanged(name) {
        this.env.model.dispatch("RENAME_THRIVE_LIST", {
    ...
    async refresh() {
        this.env.model.dispatch("REFRESH_THRIVE_LIST", { listId: this.props.listId });
    ...
    openDomainEdition() {
        this.dialog.add(DomainSelectorDialog, {
            ...
            onSelected: (domain) =>
                this.env.model.dispatch("UPDATE_THRIVE_LIST_DOMAIN", {
                    listId: this.props.listId,
