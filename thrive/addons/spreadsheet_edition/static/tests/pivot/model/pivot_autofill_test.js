...
QUnit.module("spreadsheet > pivot_autofill", {}, () => {
    ...
    QUnit.test("Autofill with pivot positions", async function (assert) {
        const { model } = await createSpreadsheetWithPivot();
        setCellContent(model, "C3", `=THRIVE.PIVOT(1,"probability","#bar",1,"#foo",1)`);
        assert.strictEqual(
            getPivotAutofillValue(model, "C3", { direction: "left", steps: 1 }),
            `=THRIVE.PIVOT(1,"probability","#bar",1,"#foo",0)`
        );
        /** Would be negative => just copy the value */
        assert.strictEqual(
            getPivotAutofillValue(model, "C3", { direction: "left", steps: 2 }),
            `=THRIVE.PIVOT(1,"probability","#bar",1,"#foo",1)`
        );
        assert.strictEqual(
            getPivotAutofillValue(model, "C3", { direction: "right", steps: 1 }),
            `=THRIVE.PIVOT(1,"probability","#bar",1,"#foo",2)`
        );
        assert.strictEqual(
            getPivotAutofillValue(model, "C3", { direction: "right", steps: 10 }),
            `=THRIVE.PIVOT(1,"probability","#bar",1,"#foo",11)`
        );
        assert.strictEqual(
            getPivotAutofillValue(model, "C3", { direction: "top", steps: 1 }),
            `=THRIVE.PIVOT(1,"probability","#bar",0,"#foo",1)`
        );
        /** Would be negative => just copy the value */
        assert.strictEqual(
        ...
        assert.strictEqual(
            getPivotAutofillValue(model, "C3", { direction: "bottom", steps: 1 }),
            `=THRIVE.PIVOT(1,"probability","#bar",2,"#foo",1)`
        );
        assert.strictEqual(
            ...
            `=THRIVE.PIVOT(1,"probability","#bar",11,"#foo",1)`
        );
    });
    ...
    QUnit.test("Autofill pivot values with date in rows", async function (assert) {
        ...
        assert.strictEqual(
            ...
            '=THRIVE.PIVOT.HEADER(1,"date:month","01/2017")'
        );
        assert.strictEqual(
    ...
    QUnit.test("Autofill pivot values with date in cols", async function (assert) {
        ...
        assert.strictEqual(
            getCellFormula(model, "B1"),
            '=THRIVE.PIVOT.HEADER(1,"date:day","04/14/2016")'
        );
        assert.strictEqual(
            getPivotAutofillValue(model, "B1", { direction: "right", steps: 1 }),
            '=THRIVE.PIVOT.HEADER(1,"date:day","04/15/2016")'
        );
        assert.strictEqual(
            getCellFormula(model, "B2"),
            '=THRIVE.PIVOT.HEADER(1,"date:day","04/14/2016","measure","probability")'
        );
        assert.strictEqual(
            getPivotAutofillValue(model, "B2", { direction: "right", steps: 1 }),
            '=THRIVE.PIVOT.HEADER(1,"date:day","04/15/2016","measure","probability")'
        );
        assert.strictEqual(
            getCellFormula(model, "B3"),
            '=THRIVE.PIVOT(1,"probability","foo",1,"date:day","04/14/2016")'
        );
        assert.strictEqual(
            getPivotAutofillValue(model, "B3", { direction: "right", steps: 1 }),
            '=THRIVE.PIVOT(1,"probability","foo",1,"date:day","04/15/2016")'
        );
    });
    ...
    QUnit.test("Autofill pivot values with date (month)", async function (assert) {
        ...
        assert.strictEqual(
            getPivotAutofillValue(model, "A3", { direction: "bottom", steps: 1 }),
            `=THRIVE.PIVOT.HEADER(1,"date:month","05/2016")`
        );
    });
    ...
    QUnit.test("Autofill pivot values with date (no defined interval)", async function (assert) {
        ...
        assert.strictEqual(
            getPivotAutofillValue(model, "A3", { direction: "bottom", steps: 1 }),
            `=THRIVE.PIVOT.HEADER(1,"date","05/2016")`
        );
    });
    ...
    QUnit.test("Tooltip of pivot formulas", async function (assert) {
        ...
        assert.deepEqual(model.getters.getTooltipFormula(`=THRIVE.PIVOT.HEADER("1")`, true), [
            { value: "Total" },
        ]);
        assert.deepEqual(model.getters.getTooltipFormula(`=THRIVE.PIVOT.HEADER("1")`, false), [
            { value: "Total" },
        ]);
    });
