...

{
    ...
    'description': """
Import your Amazon orders in Thrive and synchronize deliveries
============================================================

Key Features
------------
* Import orders from multiple accounts and marketplaces.
* Orders are matched with Thrive products based on their internal reference (SKU in Amazon).
* Deliveries confirmed in Thrive are synchronized in Amazon.
