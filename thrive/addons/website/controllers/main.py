...
from thrive import http, models, fields, _
from thrive.exceptions import AccessError
from thrive.http import request, SessionExpiredException
from thrive.osv import expression
from thrive.tools import OrderedSet, escape_psql, html_escape as escape
from thrive.addons.http_routing.models.ir_http import slug, slugify, _guess_mimetype
...
from thrive.addons.web.controllers.binary import Binary
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'l10n': l10n,
            'version': thrive.service.common.exp_version()
        }
