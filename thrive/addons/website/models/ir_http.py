...
from thrive.osv.expression import FALSE_DOMAIN
from thrive.addons.http_routing.models import ir_http
from thrive.addons.http_routing.models.ir_http import _guess_mimetype
...
def get_request_website():
    ...
    ```
    from thrive.addons.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(thrive.conf.server_wide_modules)
