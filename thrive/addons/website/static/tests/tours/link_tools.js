...
wTourUtils.registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "The new link content should be thrive website and url thrive.be",
        extra_trigger: "#oe_snippets.o_loaded",
        trigger: 'iframe .s_text_image a[href="http://thrive.be"]:contains("thrive website")',
    },
    {
        content: "The new link content should be thrive website and url thrive.be",
    ...
    ...wTourUtils.clickOnSave(),
    {
        ...
        trigger: 'iframe .s_text_image a.btn.btn-secondary[href="http://thrive.be"]:contains("thrive website")',
        run: () => {}, // It's a check.
    },
    // 4. Add link on image.
    wTourUtils.clickOnEdit(),
