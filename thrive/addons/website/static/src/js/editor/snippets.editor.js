thrive.define('website.snippet.editor', function (require) {
'use strict';
...
const ThriveEditorLib = require('@web_editor/js/editor/thrive-editor/src/utils/utils');
const getDeepRange = ThriveEditorLib.getDeepRange;
const getTraversedNodes = ThriveEditorLib.getTraversedNodes;
...
const wSnippetMenu = weSnippetEditor.SnippetsMenu.extend({
    ...
    _toggleAnimatedTextButton() {
        const sel = this.options.wysiwyg.thriveEditor.document.getSelection();
    ...
    _onAnimateTextClick(ev) {
        ...
        if (this.$currentAnimatedText.length) {
            ...
            this.options.wysiwyg.thriveEditor.historyResetLatestComputedSelection();
            this._toggleHighlightAnimatedTextButton();
