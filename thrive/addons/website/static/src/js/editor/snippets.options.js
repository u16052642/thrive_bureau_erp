thrive.define('website.editor.snippets.options', function (require) {
'use strict';
...
options.registry.OptionsTab = options.Class.extend({
    ...
    async updateUI() {
        ...
        // If the gray palette has been generated by Thrive standard option,
        ...
        // same hue by the Thrive editor, there might be rounding errors
