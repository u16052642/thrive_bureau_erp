thrive.define('website.content.snippets.animation', function (require) {
'use strict';
...
registry.slider = publicWidget.Widget.extend({
    ...
    _computeHeights: function () {
        ...
        _.each($items, el => {
            ...
            this.options.wysiwyg && this.options.wysiwyg.thriveEditor.observerUnactive('_computeHeights');
            $item.addClass('active');
            this.options.wysiwyg && this.options.wysiwyg.thriveEditor.observerActive('_computeHeights');
...
registry.mediaVideo = publicWidget.Widget.extend(MobileYoutubeAutoplayMixin, {
    ...
    start: function () {
        ...
        // integrated with Thrive (this refactoring should be done in master).
        ...
        // videos added before bug fixes or new Thrive versions where the
 ...
 * shapes in future Thrive versions.
 *
 * /!\
