...
from thrive.addons.account_accountant.tests.test_bank_rec_widget import WizardForm
...
class TestSynchStatementCreation(AccountTestInvoicingCommon):
    ...
    def test_automatic_journal_assignment(self):
        ...
        with patch('thrive.addons.account_online_synchronization.models.account_online.AccountOnlineLink.action_fetch_transactions', return_value=True):
