...
from thrive.tests import TransactionCase, tagged, Form
from thrive.addons.delivery_bpost.models.delivery_bpost import TRACKING_REF_DELIM
...
class TestDeliveryBpost(TransactionCase):
    ...
    def setUp(self):
        ...
        self.your_company.write({'name': 'Thrive Bureau ERP',
        ...
        self.agrolait.write({'name': 'Thrive Brussels',
        ...
        self.think_big_system.write({'name': "Palais de l'Élysee",
                                 ...
                                 'phone': '0142928100'})
        self.thriveinc = self.env['res.partner'].create({'name': "Thrive Inc.",
                                 'is_company': True,
