...
import thrive
from thrive import api, http
from thrive.addons import __path__ as ADDONS_PATH
from thrive.addons.base.models.assetsbundle import AssetsBundle
from thrive.addons.base.models.ir_asset import AssetPaths
from thrive.addons.base.models.ir_attachment import IrAttachment
...
from thrive.addons.base.models.ir_qweb import QWebException
from thrive.tools import mute_logger, func
...
class AddonManifestPatched(TransactionCase):
    def setUp(self):
        ...
        self.patch(thrive.modules.module, 'get_manifest', Mock(side_effect=lambda module: self.manifests.get(module, {})))
...
class TestAssetsManifest(AddonManifestPatched):
    ...
    @mute_logger('thrive.addons.base.models.ir_asset')
    def test_31(self):
