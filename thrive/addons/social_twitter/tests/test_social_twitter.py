...
from thrive.addons.social_twitter.models.social_account import SocialAccountTwitter
from thrive.addons.social_twitter.models.social_stream import SocialStreamTwitter
...
class SocialTwitterCase(SocialCase):
    ...
    def test_tweet_post_message_counter(self):
        message_to_post = '''
            Thrive is a suite of business management software tools including,
            ...
            the framework and core ERP modules is curated by the Belgium-based Thrive Bureau ERP
            Thrive is available for both on-premise and ready to use SaaS environment.
        '''
