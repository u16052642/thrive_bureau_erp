...
from thrive.tools.misc import file_open, mute_logger
from thrive.tools.translate import TranslationModuleReader, code_translations, CodeTranslations, PYTHON_TRANSLATION_COMMENT, JAVASCRIPT_TRANSLATION_COMMENT, WEB_TRANSLATION_COMMENT
from thrive import Command
from thrive.addons.base.models.ir_fields import BOOLEAN_TRANSLATIONS
...
class TestImport(common.TransactionCase):
    ...
    def test_import_from_po_file(self):
        ...
        with mute_logger('thrive.addons.base.models.res_lang'):
