...
from thrive.tests.common import HttpCase, tagged, get_db_name
from thrive.tools import config, mute_logger
...
class MobileRoutesTest(HttpCase):
    ...
    def test_version_info(self):
        """
        This request is used to check for a compatible Thrive server
        """
    ...
    def test_database_list(self):
        ...
        if config['list_db']:
            ...
            self.assertEqual(error["message"], "Thrive Bureau ERP server Error")
            self.assertEqual(error["data"]["name"], "thrive.exceptions.AccessDenied")
    ...
    def test_authenticate_wrong_database(self):
        ...
        self.assertEqual(error["code"], 200)
        self.assertEqual(error["message"], "Thrive Bureau ERP server Error")
        self.assertEqual(error["data"]["name"], "thrive.exceptions.AccessError")
