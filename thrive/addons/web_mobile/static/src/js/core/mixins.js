thrive.define('web_mobile.mixins', function (require) {
"use strict";
...
thrive.define('web_mobile.hooks', function (require) {
"use strict";

const { backButtonManager } = require('web_mobile.core');

const { onMounted, onPatched, onWillUnmount, useComponent } = require("@thrive/owl");

/**
 * This hook provides support for executing code when the back button is pressed
 * on the mobile application of Thrive. This actually replaces the default back
