/* global ThriveDeviceUtility */
thrive.define('web_mobile.core', function () {
"use strict";

var available = typeof ThriveDeviceUtility !== 'undefined';
var DeviceUtility;
var deferreds = {};
var methods = {};

if (available){
    DeviceUtility = ThriveDeviceUtility;
    delete window.ThriveDeviceUtility;
}
 ...
 * @param {Object} result
 */
window.thrive.native_notify = function (id, result) {
