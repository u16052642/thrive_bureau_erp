...
from thrive.addons.account_edi_ubl_cii.models.account_edi_common import COUNTRY_EAS
...
class AccountEdiFormat(models.Model):
    ...
    def _prepare_invoice_report(self, pdf_writer, edi_document):
        ...
        pdf_writer.embed_thrive_attachment(edi_document.attachment_id, subtype='text/xml')
