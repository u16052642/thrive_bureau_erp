...
from thrive.tools import DEFAULT_SERVER_DATE_FORMAT
...
class ResCompany(models.Model):
    ...
    def _generate_currency_rates(self, parsed_data):
        ...
        exchange rate of their main currency equal to one in Thrive.
        """
    ...
    def _parse_bcrp_data(self, available_currencies):
        ...
        for currency_thrive_code, currency_pe_code in foreigns.items():
            if currency_thrive_code not in available_currency_names:
                continue
            ...
            result[currency_thrive_code] = (rate, date_rate)
        return result
    ...
    def _parse_nbp_data(self, available_currencies):
        """ This method is used to update the currencies by using NBP (National Polish Bank) service API.
            ...
            Source: https://apps.ThriveERP.com/apps/modules/14.0/trilab_live_currency_nbp/
