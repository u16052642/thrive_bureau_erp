...
from thrive.addons.crm.tests.common import TestCrmCommon
...
class TestLeadConvert(TestCrmCommon):
    ...
    def test_potential_duplicates(self):
        ...
        lead_1 = self.env['crm.lead'].create({
            ...
            'type': 'lead',
            'partner_name': 'Alice',
            'email_from': 'alice@thrivebureau.com',
        })
        ...
        lead_7 = self.env['crm.lead'].create({
            ...
            'type': 'opportunity',
            'partner_name': 'Bob Doe',
            'email_from': 'bob@thrivebureau.com',
        })
