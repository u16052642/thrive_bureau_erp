...
from thrive.addons.base.tests.test_format_address_mixin import FormatAddressCase
from thrive.addons.crm.models.crm_lead import PARTNER_FIELDS_TO_SYNC, PARTNER_ADDRESS_FIELDS_TO_SYNC
from thrive.addons.crm.tests.common import TestCrmCommon, INCOMING_EMAIL
from thrive.addons.phone_validation.tools.phone_validation import phone_format
from thrive.exceptions import UserError
from thrive.tests.common import Form, tagged, users
