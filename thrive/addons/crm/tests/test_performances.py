...
from thrive.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('thrive.models.unlink', 'thrive.addons.crm.models.crm_team', 'thrive.addons.crm.models.crm_team_member')
