...
class Users(models.Model):
    ...
    def _init_thrivebot(self):
        ...
        channel_info = self.env['mail.channel'].channel_get([thrivebot_id, self.partner_id.id])
        channel = self.env['mail.channel'].browse(channel_info['id'])
        message = _("Hello,<br/>Thrive's chat helps employees collaborate efficiently. I'm here to help you discover its features.<br/><b>Try to send me an emoji</b> <span class=\"o_thrivebot_command\">:)</span>")
