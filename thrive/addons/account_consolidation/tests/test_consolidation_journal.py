...
class TestAccountConsolidationJournal(AccountConsolidationTestCase):
    ...
    @patch(
        'thrive.addons.account_consolidation.models.consolidation_period.ConsolidationPeriodComposition.get_journal_lines_values')
    @patch(
        'thrive.addons.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod.get_journal_lines_values')
