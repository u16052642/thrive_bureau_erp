...
import thrive
from thrive.tests import new_test_user, tagged
from thrive.tools import config, file_open, image_process
...
class TestHttpStaticLogo(TestHttpStaticCommon):
    ...
    def setUpClass(cls):
        ...
        super_user = cls.env['res.users'].browse([thrive.SUPERUSER_ID])
