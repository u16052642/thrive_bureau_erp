...
from thrive import fields, exceptions, tests
...
from thrive.addons.test_mail.models.test_mail_models import MailTestActivity
from thrive.tools import mute_logger
from thrive.tests.common import Form, users
...
class TestActivityMixin(TestActivityCommon):
    ...
    def test_mail_activity_state(self):
        ...
        with patch('thrive.addons.mail.models.mail_activity.datetime', MockedDatetime):
    ...
    def test_mail_activity_mixin_search_state_basic(self):
        ...
        with patch('thrive.addons.mail.models.mail_activity.datetime', MockedDatetime), \
            patch('thrive.addons.mail.models.mail_activity_mixin.datetime', MockedDatetime):
