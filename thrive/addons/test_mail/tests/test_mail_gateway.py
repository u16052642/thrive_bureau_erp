...
from thrive.addons.test_mail.data import test_mail_data
from thrive.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE
from thrive.addons.test_mail.models.test_mail_models import MailTestGateway
from thrive.addons.test_mail.tests.common import TestMailCommon
from thrive.sql_db import Cursor
from thrive.tests import tagged
from thrive.tests.common import users
from thrive.tools import email_split_and_format, formataddr, mute_logger
...
class TestEmailParsing(TestMailCommon):
    ...
    def test_message_parse_and_replace_binary_octetstream(self):
        ...
        with self.assertLogs('thrive.addons.mail.models.mail_thread', level="WARNING") as capture:
        ...
        self.assertEqual(capture.output, [
            ("WARNING:thrive.addons.mail.models.mail_thread:Message containing an unexpected "
...
class TestMailgateway(TestMailCommon):
    ...
    @mute_logger('thrive.addons.mail.models.mail_thread', 'thrive.models')
    ...
    @mute_logger('thrive.addons.mail.models.mail_thread')
    ...
    def test_message_process_followers(self):
        """ Incoming email: recognized author not archived and not thrivebot: added as follower """
        ...
        thrivebot.active = True
        thrivebot.email = 'thrivebot@example.com'
        with self.mock_mail_gateway():
            record4 = self.format_and_process(
                MAIL_TEMPLATE, thrivebot.email_formatted, 'groups@test.com',
                subject='Thrivebot Automatic Answer')

        self.assertEqual(record4.message_ids[0].author_id, thrivebot)
        self.assertEqual(record4.message_ids[0].email_from, thrivebot.email_formatted)
    ...
    @mute_logger('thrive.addons.mail.models.mail_thread', 'thrive.models.unlink', 'thrive.addons.mail.models.mail_mail')
    ...
    @mute_logger('thrive.addons.mail.models.mail_thread', 'thrive.addons.mail.models.mail_mail', 'thrive.models.unlink')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by thrive should update thread accordingly """
    ...
    def test_message_process_references_external_buggy_message_id(self):
        ...
        thrive should update thread accordingly. Special case when the
    ...
    def test_message_process_extra_model_res_id(self):
        """ Incoming email with ref holding model / res_id but that does not match any message in the thread: must raise since ThriveERP saas-3 """
        ...
        # Thrive 10 update: compat mode has been removed and should not work anymore
    ...
    @mute_logger('thrive.addons.mail.models.mail_thread', 'thrive.addons.mail.models.mail_mail')
