...
from thrive.addons.base.tests.test_ir_cron import CronMixinCase
from thrive.addons.mail.tests.common import mail_new_test_user
from thrive.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from thrive.addons.test_mail.models.test_mail_models import MailTestSimple
from thrive.addons.test_mail.tests.common import TestMailCommon, TestRecipients
from thrive.api import call_kw
from thrive.exceptions import AccessError
from thrive.tests import tagged
from thrive.tools import mute_logger, formataddr
...
class TestMailNotifyAPI(TestMessagePostCommon):
    ...
    @mute_logger('thrive.models.unlink')
    @users('employee')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    @mute_logger('thrive.addons.mail.models.mail_mail', 'thrive.models.unlink')
    @users('employee')
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. thrivebot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
    ...
    @users('employee')
    @mute_logger('thrive.addons.mail.models.mail_mail', 'thrive.addons.mail.models.mail_message_schedule', 'thrive.models.unlink')
    ...
    @users('employee')
    @mute_logger('thrive.addons.mail.models.mail_mail', 'thrive.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('thrive.addons.mail.models.mail_mail', 'thrive.addons.mail.models.mail_thread')
    @users('employee')
...
class TestMessagePostHelpers(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('thrive.addons.mail.models.mail')
    ...
    @users('employee')
    @mute_logger('thrive.addons.mail.models.mail_mail', 'thrive.tests')
