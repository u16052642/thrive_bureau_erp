...
from thrive.addons.test_mail.models.test_mail_models import MailTestTicket
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('thrive.tests', 'thrive.addons.mail.models.mail_mail', 'thrive.models.unlink')
    ...
    @mute_logger('thrive.tests', 'thrive.addons.base.models.ir_rule', 'thrive.addons.mail.models.mail_mail', 'thrive.models.unlink')
...
class TestComposerResultsComment(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('thrive.models.unlink', 'thrive.addons.mail.models.mail_mail')
