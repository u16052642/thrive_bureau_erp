...
from thrive.tools import is_html_empty, mute_logger, formataddr
from thrive.tests import tagged, users
...
class TestMessageAccess(TestMailCommon):
    ...
    def test_mail_message_access_create_wo_parent_access(self):
        ...
        partner_1 = self.env['res.partner'].create({
            'name': 'Jitendra Prajapati (jpr-thrive)',
            'email': 'jpr@thrivebureau.com',
        })
