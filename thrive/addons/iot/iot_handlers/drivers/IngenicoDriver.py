...
from thrive.addons.hw_drivers.iot_handlers.interfaces.SocketInterface import socket_devices

_logger = logging.getLogger(__name__)

# Because drivers don't get loaded as normal Python modules but directly in
# load_iot_handlers called by Manager.run, the log levels that get applied to the thrive
...
# be ERROR at the thrive-bin level. In order to work around this, it's possible to
...
class IngenicoDriver(Driver):
    ...
    def _action_default(self, data):
        """Action trigered on request from Thrive Bureau ERP.
        Override
        """
        try:
