# -*- coding: utf-8 -*-
from thrive import api, Command, fields, models, _
...
from thrive.tools import remove_accents
import logging
import re
...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(string='Communication Standard', required=True, selection=[('thrive', 'Thrive'), ('euro', 'European')], default=_default_invoice_reference_model, help="You can choose different models for each type of reference. The default one is the Thrive reference.")
    ...
    inbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Get paid by any method outside of Thrive.\n"
    ...
    outbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Pay by any method outside of Thrive.\n"
        "Check: Pay bills by check and print it from Thrive Bureau ERP.\n"
    ...
    alias_id = fields.Many2one('mail.alias', string='Email Alias', help="Send one separate email for each invoice.\n\n"
                                                                  ...
                                                                  "Only PDF and XML files will be interpreted by Thrive", copy=False)
