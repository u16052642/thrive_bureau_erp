# -*- coding: utf-8 -*-
from thrive import models, fields, api, _, Command
from thrive.exceptions import UserError, ValidationError
from thrive.tools.misc import format_date, formatLang
...
class AccountPayment(models.Model):
    ...
    payment_method_line_id = fields.Many2one('account.payment.method.line', string='Payment Method',
        ...
        help="Manual: Pay or Get paid by any method outside of Thrive.\n"
