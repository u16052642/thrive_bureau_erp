...
from thrive import api, fields, models, Command, _, osv
from thrive import SUPERUSER_ID
from thrive.exceptions import UserError, ValidationError
from thrive.http import request
from thrive.addons.account.models.account_tax import TYPE_TAX_USE
from thrive.addons.account.models.account_account import ACCOUNT_CODE_REGEX
...
def update_taxes_from_templates(cr, chart_template_xmlid):
    ...
    def _notify_accountant_managers(taxes_to_check):
        ...
        thrivebot = env.ref('base.partner_root')
        message_body = _(
