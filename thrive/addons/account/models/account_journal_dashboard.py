...
from thrive import models, api, _, fields
from thrive.exceptions import UserError
from thrive.osv import expression
from thrive.release import version
from thrive.tools import DEFAULT_SERVER_DATE_FORMAT as DF
from thrive.tools.misc import formatLang, format_date as thrive_format_date, get_lang
import random
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                act = {
                    ...
                    'date': thrive_format_date(self.env, activity.get('date_deadline'))
                }
