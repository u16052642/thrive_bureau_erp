...
from thrive import api, fields, models, Command, _
from thrive.exceptions import ValidationError, UserError
from thrive.tools import frozendict, formatLang, format_date, float_is_zero
from thrive.tools.sql import create_index
...
class AccountMoveLine(models.Model):
    ...
    def _prepare_reconciliation_single_partial(self, debit_vals, credit_vals):
        ...
        if debit_vals['currency'] == credit_vals['currency'] == company_currency \
            ...
            debit_rate = get_thrive_rate(debit_vals)
            ...
            credit_rate = get_thrive_rate(credit_vals)
