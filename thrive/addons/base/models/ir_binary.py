...
from thrive.exceptions import MissingError, UserError
from thrive.http import Stream, request
from thrive.tools import file_open, replace_exceptions
from thrive.tools.image import image_process, image_guess_size_from_field_name
from thrive.tools.mimetypes import guess_mimetype, get_extension
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:thrive.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~thrive.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`thrive.tools.image.image_process`.
