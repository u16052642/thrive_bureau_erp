...
import thrive
from thrive import api, http, models, tools, SUPERUSER_ID
from thrive.exceptions import AccessDenied, AccessError, MissingError
from thrive.http import request, Response, ROUTING_KEYS, Stream
from thrive.modules.registry import Registry
from thrive.service import security
from thrive.tools import consteq, submap
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = registry._init_modules.union(thrive.conf.server_wide_modules)
            if tools.config['test_enable'] and thrive.modules.module.current_test:
                installed.add(thrive.modules.module.current_test)
