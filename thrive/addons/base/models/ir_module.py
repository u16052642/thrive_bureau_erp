...
from thrive.exceptions import AccessDenied, UserError
from thrive.osv import expression
from thrive.tools.parse_version import parse_version
from thrive.tools.misc import topological_sort
from thrive.tools.translate import TranslationImporter
from thrive.http import request
from thrive.modules import get_module_path, get_module_resource
...
class Module(models.Model):
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'Thrive Enterprise Edition License v1.0'),
        ('OPL-1', 'Thrive Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('Thrive Enterprise Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("Thrive is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(thrive.conf.server_wide_modules) & set(self.mapped('name'))
    ...
    def install_from_urls(self, urls):
        ...
        OPENERP = thrive.release.product_name.lower()
        ...
        try:
            ...
            for module_name, url in urls.items():
                ...
                try:
                    _logger.info('Downloading module `%s` from ThriveERP Apps', module_name)
            ...
            if urls.get(OPENERP):
                ...
                # copy all modules in the SERVER/thrive/addons directory to the new "thrive" module (except base itself)
                for d in os.listdir(base_path):
                    if d != 'base' and os.path.isdir(os.path.join(base_path, d)):
                        destdir = os.path.join(tmp, OPENERP, 'addons', d)    # XXX 'thrive' subdirectory ?
                ...
                _logger.info('Copy downloaded module `thrive` to `%s`', server_dir)
    ...
    def get_apps_server(self):
        return tools.config.get('apps_server', 'https://apps.thrivebureau.com/apps')
