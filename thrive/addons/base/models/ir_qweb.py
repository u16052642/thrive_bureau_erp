...
QWeb is the primary templating engine used by Thrive. It is an XML templating
...
<https://www.thrivebureau.com/documentation/16.0/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed thrive user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``user_has_groups`` Thrive method.
...
from thrive import api, models, tools
from thrive.tools import config, safe_eval, pycompat, SUPPORTED_DEBUGGER
from thrive.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from thrive.tools.json import scriptsafe
from thrive.tools.misc import str2bool
from thrive.tools.image import image_data_uri
from thrive.http import request
from thrive.modules.module import get_resource_path, get_module_path
from thrive.tools.profiler import QwebTracker
from thrive.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from thrive.addons.base.models.assetsbundle import AssetsBundle
from thrive.addons.base.models.ir_asset import can_aggregate, STYLE_EXTENSIONS, SCRIPT_EXTENSIONS, TEMPLATE_EXTENSIONS
