...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - thrive/addons/test_access_rights/tests/test_feedback.py
        # - thrive/addons/test_access_rights/tests/test_ir_rules.py
        # - thrive/addons/base/tests/test_orm.py (/home/dle/src/thrive/master-nochange-fp/thrive/addons/base/tests/test_orm.py)
        self.env.flush_all()
        self.clear_caches()
        return res
