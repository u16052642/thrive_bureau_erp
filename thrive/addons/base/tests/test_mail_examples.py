...
cite="mid:CAEJSRZvWvud8c6Qp=wfNG6O1+wK3i_jb33qVrF7XyrgPNjnyUA@mail.gmail.com"
    ...
    on this Thrive mailinglist, but when you start implying that Postgres
...
HOTMAIL_1 = u"""<div>
    <div dir="ltr"><br>
        I have an amazing company, i'm learning ThriveERP, it is a small company yet, but plannig to grow up quickly.
        ...
        <div>
            ...
            Best regards,<br>
            <pre>
                <a href="http://thrivebureau.com" target="_blank">http://thrivebureau.com</a>
...
HOTMAIL_1_OUT = [
    ...
    u"""<pre data-o-mail-quote="1">
                <a href="http://thrivebureau.com" target="_blank" data-o-mail-quote="1">http://thrivebureau.com</a>
                Belgium: +32.81.81.37.00
                U.S.: +1 (650) 307-6736
                India: +91 (79) 40 500 100
            </pre>"""]
...
<div class="WordSection1">
        ...
        <p class="MsoNormal">
            <span style="font-size:11.0pt;font-family:&quot;Calibri&quot;,&quot;sans-serif&quot;;color:#1F497D">
                ...
                If we adopt ThriveERP we will probably move to Linux or look for a hosted SaaS option.
            </span>
        </p>
        <p></p>
        <p></p>
        ...
        <p></p>
        <p>I noticed you recently downloaded ThriveERP. </p>
        <p></p>
        <p>
            Uou mentioned you wish to use ThriveERP in your own company. Please let me more about your
            business needs and requirements? When will you be available to discuss about your project?
        </p>
        <p></p>
        <p>Thanks for your interest in ThriveERP, </p>
        <p></p>
        ...
        <pre>--<p></p></pre>
        <pre>Nicolas<p></p></pre>
        <pre><a href="http://thrivebureau.com">http://thrivebureau.com</a><p></p></pre>
...
MSOFFICE_1_OUT = [u'I noticed you recently downloaded ThriveERP.', 'Uou mentioned you wish to use ThriveERP in your own company.', 'Belgium: +32.81.81.37.00']
...
B-1367 Gérompont
Tel: +32.81.81.37.00
Web: http://www.thrivebureau.com</pre>"""
...
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    <div>Hello</div>
    <div>I have just installed Thrive 9 and I've got the following error:</div>
    <div>&nbsp;</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content openerp">
                <div class="modal-header"> 
                    <h4 class="modal-title">Thrive Error<span class="o_subtitle text-muted"></span></h4>
                </div>
