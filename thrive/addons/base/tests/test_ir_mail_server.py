...
from thrive.addons.base.tests import test_mail_examples
from thrive.addons.base.tests.common import MockSmtplibCase
...
class TestIrMailServer(TransactionCase, MockSmtplibCase):
    ...
    def test_mail_server_priorities(self):
        ...
        # remove the notifications email to simulate a mis-configured Thrive database
        ...
        with mute_logger('thrive.addons.base.models.ir_mail_server'):
    ...
    @mute_logger('thrive.models.unlink')
    @patch.dict("thrive.tools.config.options", {"from_filter": "test.com", "smtp_server": "example.com"})
    def test_mail_server_binary_arguments_domain(self):
        """Test the configuration provided in the thrive-bin arguments.
        ...
        # Remove all mail server so we will use the thrive-bin arguments
    ...
    def test_mail_server_mail_default_from_filter(self):
        """Test that the config parameter "mail.default.from_filter" overwrite the thrive-bin
