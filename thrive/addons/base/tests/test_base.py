...
from thrive import SUPERUSER_ID, Command
from thrive.exceptions import RedirectWarning, UserError, ValidationError
from thrive.tests.common import TransactionCase, BaseCase
from thrive.tools import mute_logger
from thrive.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('thrive.tools.safe_eval')
    def test_05_safe_eval_forbiddon(self):
        ...
        with self.assertRaises(ValueError):
            safe_eval("import thrive", mode="exec")
