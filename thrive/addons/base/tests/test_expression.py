...
from thrive.addons.base.tests.common import SavepointCaseWithUserDemo
...
class TestExpression(SavepointCaseWithUserDemo):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('thrive.osv.expression'):
    ...
    def test_15_m2o(self):
        ...
        # that don't have ThriveERP has a parent company, you expect to find,
    ...
    def test_accent(self):
        ...
        with patch('thrive.osv.expression.get_unaccent_wrapper') as w:
    ...
    def test_active(self):
        ...
        vals = {
            ...
            'child_ids': [Command.create({'name': 'address of ThriveERP Test', 'country_id': self.ref("base.be")})],
        }
        Partner.create(vals)
