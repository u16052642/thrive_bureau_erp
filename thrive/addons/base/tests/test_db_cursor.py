...
def registry():
    return thrive.registry(common.get_db_name())
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = thrive.api.Environment(self.cr, thrive.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('thrive.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:thrive.sql_db:Found different un-closed cursor', msg)
