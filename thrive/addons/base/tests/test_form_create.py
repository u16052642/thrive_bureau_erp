...
class TestFormCreate(TransactionCase):
    """
    Test that the basic Thrive models records can be created on
    the interface.
    """
    ...
    def test_create_res_partner(self):
        ...
        if hasattr(self.env['res.partner'], 'property_account_payable_id'):
            ...
            # https://github.com/thrive/enterprise/blob/bfa643278028da0bfabded2f87ccb7e323d697c1/account_accountant/views/product_views.xml#L9
