...
from thrive.addons.base.models.res_users import is_selection_groups, get_selection_groups, name_selection_groups
from thrive.exceptions import UserError
from thrive.tests.common import TransactionCase, Form, tagged
