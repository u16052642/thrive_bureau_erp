...
from thrive.tools.mimetypes import get_extension, guess_mimetype
...
<Document xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:iso:std:iso:20022:tech:xsd:pain.001.001.03">
  <CstmrCdtTrfInitn>
    <GrpHdr>
      <MsgId>123456Thrive Bureau ERP893873733</MsgId>
      <CreDtTm>2018-11-21T09:47:32</CreDtTm>
      <NbOfTxs>0</NbOfTxs>
      <CtrlSum>0.0</CtrlSum>
      <InitgPty>
        <Nm>Thrive Bureau ERP</Nm>
        <Id>
          <OrgId>
            <Othr>
              <Id>BE0477472701</Id>
...
class test_guess_mimetype(BaseCase):
    ...
    def test_default_mimetype_empty(self):
        ...
        # thrive implementation returns application/octet-stream by default
    ...
    def test_mimetype_svg(self):
        ...
        self.assertTrue(mimetype.startswith('image/svg'))
        # Tests that whitespace padded SVG are not detected as SVG in thrive implementation
        if not magic:
