...
from thrive.addons.base.models.ir_mail_server import extract_rfc2822_addresses
from thrive.tests.common import BaseCase, TransactionCase
...
class EmailConfigCase(TransactionCase):
    @patch.dict("thrive.tools.config.options", {"email_from": "settings@example.com"})
