...
tour.register('sign_tour', {
    ...
    content: Markup(_t("Since you're the one signing this document, you can do it directly within Thrive.<br>External users can use the link provided by email.")),
    position: "bottom",
},{
