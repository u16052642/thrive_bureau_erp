...
from thrive import api, fields, models, http, _, Command
from thrive.tools import config, get_lang, is_html_empty, formataddr, groupby, format_date
...
class SignRequest(models.Model):
    ...
    def _message_send_mail(self, body, email_layout_xmlid, message_values, notif_values, mail_values, force_send=False, **kwargs):
        ...
        # See @tde-banana-thrive for details
