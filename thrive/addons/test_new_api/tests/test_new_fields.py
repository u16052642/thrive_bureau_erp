...
from thrive import models, fields, Command
from thrive.addons.base.tests.common import TransactionCaseWithUserDemo
from thrive.exceptions import AccessError, MissingError, UserError, ValidationError
from thrive.tests import common
from thrive.tools import mute_logger, float_repr
from thrive.tools.date_utils import add, subtract, start_of, end_of
...
class TestFields(TransactionCaseWithUserDemo):
    ...
    @mute_logger('thrive.addons.base.models.ir_model')
    ...
    def test_85_binary_guess_zip(self):
        from thrive.addons.base.tests.test_mimetypes import ZIP
    ...
    def test_86_text_base64_guess_svg(self):
        from thrive.addons.base.tests.test_mimetypes import SVG
...
class TestX2many(common.TransactionCase):
    ...
    def test_10_ondelete_many2many(self):
        ...
        with self.assertRaises(psycopg2.IntegrityError):
            with mute_logger('thrive.sql_db'), self.cr.savepoint():
                record_a.unlink()
...
class TestFieldParametersValidation(common.TransactionCase):
    def test_invalid_parameter(self):
        ...
        with self.assertLogs('thrive.fields', level='WARNING') as cm:
            self.registry.setup_models(self.env.cr)

        self.assertTrue(cm.output[0].startswith(
            "WARNING:thrive.fields:Field test_new_api.field_parameter_validation.name: "
...
class TestPrecomputeModel(common.TransactionCase):
    ...
    def test_precompute_consistency(self):
        ...
        with self.assertLogs('thrive.modules.registry', level='WARNING'):
            self.registry.setup_models(self.cr)
