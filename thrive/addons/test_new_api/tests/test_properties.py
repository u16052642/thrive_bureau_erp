...
from thrive.tests.common import Form, TransactionCase, users
...
class PropertiesCase(TransactionCase):
    ...
    @mute_logger('thrive.models.unlink', 'thrive.fields')
    ...
    @users('test')
    @mute_logger('thrive.addons.base.models.ir_rule', 'thrive.fields')
