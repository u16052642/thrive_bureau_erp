...
term representation was ['=', 'company_id.name', 'ThriveERP']. Used in a
...
ThriveERP will use the SQL function 'unaccent' when available for the
...
Finally, to instruct ThriveERP to really use the unaccent function, you have to
...
from thrive.tools import pycompat, Query, _generate_table_alias, sql
...
def get_unaccent_wrapper(cr):
    if thrive.registry(cr.dbname).has_unaccent:
