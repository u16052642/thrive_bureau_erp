...
from thrive.modules.module import get_module_root, MANIFEST_NAMES
from thrive.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the Thrive server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            thrive.tools.config['init']['base'] = True
