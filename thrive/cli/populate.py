        ...
        try:
            ...
            for model in ordered_models:
                if profiling_enabled:
                    profiling_context = thrive.tools.profiler.Profiler(
                ...
                if commit:
                    ...
                    commit_context = patch('thrive.sql_db.Cursor.commit')
