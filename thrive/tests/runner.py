...
stats_logger = logging.getLogger('thrive.tests.stats')
...
$
""", re.VERBOSE)
class ThriveTestResult(unittest.result.TestResult):
    """
    ...
    def getErrorCallerInfo(self, error, test):
        ...
        # only test case should be executed in thrive, this is only a safe guard
