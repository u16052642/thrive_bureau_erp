...
"""
The PostgreSQL connector is a connectivity layer between the ThriveERP code and
...
class Cursor(BaseCursor):
    """Represents an open transaction to the PostgreSQL DB backend,
       ...
       ``cursor`` objects.
        ...
        such as ThriveERP, we need the best guarantees that no data
        ...
        ThriveERP implements its own level of locking protection
        ...
        the default transaction isolation level for ThriveERP cursors, as
...
def close_db(db_name):
    """ You might want to call thrive.modules.registry.Registry.delete(db_name) along this function."""
    global _Pool
    if _Pool:
